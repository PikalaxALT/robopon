...
; HuC3
DEF HuC3SRamMode   EQU $0000
DEF HuC3RomBank    EQU $2000
DEF HuC3SRamBank   EQU $4000
DEF HuC3LatchClock EQU $6000
DEF HuC3RTC        EQU $a000

DEF SRAM_READONLY     EQU $0
DEF SRAM_READWRITE    EQU $a
DEF RTC_WRITE         EQU $b
DEF RTC_READ          EQU $c
DEF RTC_STATUS        EQU $d
DEF CART_IR_ON        EQU $e

DEF NUM_SRAM_BANKS EQU 4

DEF SYSID_CGB EQU $11
