...
Func_8b49c:: ; 8b49c
	ld e, $01 ; 8B49C (22:749c) -> 1E 01
	ld hl, Data_8b40e ; 8B49E (22:749e) -> 21 0E 74
	scall LoadWarps ; 8B4A1 (22:74a1) -> CD 3A 40
	ld e, $01 ; 8B4A4 (22:74a4) -> 1E 01
	ld hl, Data_8b419 ; 8B4A6 (22:74a6) -> 21 19 74
	scall Func_80ce7 ; 8B4A9 (22:74a9) -> CD E7 4C
	ld a, $03 ; 8B4AC (22:74ac) -> 3E 03
	scall Func_80d01 ; 8B4AE (22:74ae) -> CD 01 4D
	ld e, $05 ; 8B4B1 (22:74b1) -> 1E 05
	ld hl, Data_8b41e ; 8B4B3 (22:74b3) -> 21 1E 74
	scall LoadEncounters ; 8B4B6 (22:74b6) -> CD 24 4D
	ld hl, $003c ; 8B4B9 (22:74b9) -> 21 3C 00
	scall CheckEventFlag ; 8B4BC (22:74bc) -> CD 2E 46
	or a ; 8B4BF (22:74bf) -> B7
	jp nz, label_8b4cb ; 8B4C0 (22:74c0) -> C2 CB 74
	ld e, $02 ; 8B4C3 (22:74c3) -> 1E 02
	ld hl, Data_8b464 ; 8B4C5 (22:74c5) -> 21 64 74
	scall LoadMapObjects ; 8B4C8 (22:74c8) -> CD FB 40
label_8b4cb:
	ld e, $02 ; 8B4CB (22:74cb) -> 1E 02
	ld hl, Data_8b480 ; 8B4CD (22:74cd) -> 21 80 74
	scall LoadMapObjects ; 8B4D0 (22:74d0) -> CD FB 40
	ld a, $09 ; 8B4D3 (22:74d3) -> 3E 09
	scall PlayMusic ; 8B4D5 (22:74d5) -> CD E6 4E
	scall Func_8001c ; 8B4D8 (22:74d8) -> CD 1C 40
	ld hl, $02e2 ; 8B4DB (22:74db) -> 21 E2 02
	scall LandmarkSign ; 8B4DE (22:74de) -> CD 72 4F
	ret  ; 8B4E1 (22:74e1) -> C9
...
Func_8b4ea:
	ld a, e ; 8B4EA (22:74ea) -> 7B
	cp $02 ; 8B4EB (22:74eb) -> FE 02
	jp nz, label_8b53c ; 8B4ED (22:74ed) -> C2 3C 75
	xor a ; 8B4F0 (22:74f0) -> AF
	scall PlayMusic ; 8B4F1 (22:74f1) -> CD E6 4E
	ld c, $01 ; 8B4F4 (22:74f4) -> 0E 01
	ld de, Data_8b4e2 ; 8B4F6 (22:74f6) -> 11 E2 74
	ld a, $22 ; 8B4F9 (22:74f9) -> 3E 22
	scall MovePlayer ; 8B4FB (22:74fb) -> CD 3E 46
	scall WaitNPCStep ; 8B4FE (22:74fe) -> CD 0C 42
	ld a, $01 ; 8B501 (22:7501) -> 3E 01
	scall PlayMusic ; 8B503 (22:7503) -> CD E6 4E
	ld hl, $007d ; 8B506 (22:7506) -> 21 7D 00
	scall PrintTextWithNPCName ; 8B509 (22:7509) -> CD A9 44
	ld bc, Data_8b4e6 ; 8B50C (22:750c) -> 01 E6 74
	ld e, $22 ; 8B50F (22:750f) -> 1E 22
	xor a ; 8B511 (22:7511) -> AF
	scall MovePersonAndWait ; 8B512 (22:7512) -> CD 88 46
	scall WaitNPCStep ; 8B515 (22:7515) -> CD 0C 42
	ld e, $00 ; 8B518 (22:7518) -> 1E 00
	xor a ; 8B51A (22:751a) -> AF
	scall SpriteFace ; 8B51B (22:751b) -> CD 95 40
	ld e, $00 ; 8B51E (22:751e) -> 1E 00
	xor a ; 8B520 (22:7520) -> AF
	scall SetPersonVisibilityState ; 8B521 (22:7521) -> CD 3D 41
	ld e, $00 ; 8B524 (22:7524) -> 1E 00
	ld a, $01 ; 8B526 (22:7526) -> 3E 01
	scall SetPersonVisibilityState ; 8B528 (22:7528) -> CD 3D 41
	xor a ; 8B52B (22:752b) -> AF
	scall PlayMusic ; 8B52C (22:752c) -> CD E6 4E
	ld a, $09 ; 8B52F (22:752f) -> 3E 09
	scall PlayMusic ; 8B531 (22:7531) -> CD E6 4E
	ld e, $01 ; 8B534 (22:7534) -> 1E 01
	ld hl, $003c ; 8B536 (22:7536) -> 21 3C 00
	scall EventFlagAction ; 8B539 (22:7539) -> CD 1B 46
label_8b53c:
	ret  ; 8B53C (22:753c) -> C9

Func_8b53d:
	ld a, e ; 8B53D (22:753d) -> 7B
	or a ; 8B53E (22:753e) -> B7
	jp nz, label_8b58b ; 8B53F (22:753f) -> C2 8B 75
	ld a, [wPlayerFacing] ; 8B542 (22:7542) -> FA 38 C8
	or a ; 8B545 (22:7545) -> B7
	jp z, label_8b54c ; 8B546 (22:7546) -> CA 4C 75
	jp label_8b58b ; 8B549 (22:7549) -> C3 8B 75
label_8b54c:
	ld hl, $0059 ; 8B54C (22:754c) -> 21 59 00
	scall CheckEventFlag ; 8B54F (22:754f) -> CD 2E 46
	cp $01 ; 8B552 (22:7552) -> FE 01
	jp nz, label_8b560 ; 8B554 (22:7554) -> C2 60 75
	ld hl, $0283 ; 8B557 (22:7557) -> 21 83 02
	scall PrintTextStandard ; 8B55A (22:755a) -> CD 98 44
	jp label_8b58b ; 8B55D (22:755d) -> C3 8B 75
label_8b560:
	xor a ; 8B560 (22:7560) -> AF
	scall Func_80653 ; 8B561 (22:7561) -> CD 53 46
	ld c, $01 ; 8B564 (22:7564) -> 0E 01
	ld e, $01 ; 8B566 (22:7566) -> 1E 01
	ld a, $09 ; 8B568 (22:7568) -> 3E 09
	scall LoadEmote ; 8B56A (22:756a) -> CD 76 41
	ld a, $5a ; 8B56D (22:756d) -> 3E 5A
	scall PlaySFX ; 8B56F (22:756f) -> CD FE 4E
	scall WaitEmote ; 8B572 (22:7572) -> CD D5 41
	scall HideEmote ; 8B575 (22:7575) -> CD 8B 41
	ld l, $06 ; 8B578 (22:7578) -> 2E 06
	push hl ; 8B57A (22:757a) -> E5
	ld c, $07 ; 8B57B (22:757b) -> 0E 07
	ld e, $00 ; 8B57D (22:757d) -> 1E 00
	ld a, $1c ; 8B57F (22:757f) -> 3E 1C
	scall Func_80dff ; 8B581 (22:7581) -> CD FF 4D
	pop bc ; 8B584 (22:7584) -> C1
	ld hl, $001e ; 8B585 (22:7585) -> 21 1E 00
	scall ScriptSleep ; 8B588 (22:7588) -> CD 8F 46
label_8b58b:
	ret  ; 8B58B (22:758b) -> C9

Func_8b58c:
	ld a, e ; 8B58C (22:758c) -> 7B
	or a ; 8B58D (22:758d) -> B7
	jp nz, label_8b5dc ; 8B58E (22:758e) -> C2 DC 75
	ld a, [wc790] ; 8B591 (22:7591) -> FA 90 C7
	or a ; 8B594 (22:7594) -> B7
	jp z, label_8b5a9 ; 8B595 (22:7595) -> CA A9 75
	ld a, [wc790] ; 8B598 (22:7598) -> FA 90 C7
	cp $07 ; 8B59B (22:759b) -> FE 07
	jp nc, label_8b5a9 ; 8B59D (22:759d) -> D2 A9 75
	ld hl, $03dd ; 8B5A0 (22:75a0) -> 21 DD 03
	scall PrintTextStandard ; 8B5A3 (22:75a3) -> CD 98 44
	jp label_8b5dc ; 8B5A6 (22:75a6) -> C3 DC 75
label_8b5a9:
	ld hl, $0059 ; 8B5A9 (22:75a9) -> 21 59 00
	scall CheckEventFlag ; 8B5AC (22:75ac) -> CD 2E 46
	or a ; 8B5AF (22:75af) -> B7
	jp nz, label_8b5c9 ; 8B5B0 (22:75b0) -> C2 C9 75
	ld e, $01 ; 8B5B3 (22:75b3) -> 1E 01
	ld hl, $0059 ; 8B5B5 (22:75b5) -> 21 59 00
	scall EventFlagAction ; 8B5B8 (22:75b8) -> CD 1B 46
	ld a, $32 ; 8B5BB (22:75bb) -> 3E 32
	scall PlaySFX ; 8B5BD (22:75bd) -> CD FE 4E
	ld hl, $035b ; 8B5C0 (22:75c0) -> 21 5B 03
	scall PrintTextStandard ; 8B5C3 (22:75c3) -> CD 98 44
	jp label_8b5dc ; 8B5C6 (22:75c6) -> C3 DC 75
label_8b5c9:
	ld e, $00 ; 8B5C9 (22:75c9) -> 1E 00
	ld hl, $0059 ; 8B5CB (22:75cb) -> 21 59 00
	scall EventFlagAction ; 8B5CE (22:75ce) -> CD 1B 46
	ld a, $28 ; 8B5D1 (22:75d1) -> 3E 28
	scall PlaySFX ; 8B5D3 (22:75d3) -> CD FE 4E
	ld hl, $035c ; 8B5D6 (22:75d6) -> 21 5C 03
	scall PrintTextStandard ; 8B5D9 (22:75d9) -> CD 98 44
label_8b5dc:
	ret  ; 8B5DC (22:75dc) -> C9

Data_8b5dd:
IF DEF(SUN)
	db $07, $04, $01, $01, $03, $0c, $15, $12, $16, $12, $2e, $01, $0b, $02, $01, $03, $0e, $10, $08, $10, $09, $2e, $03, $08, $0b, $03, $18, $00, $03, $09, $09, $05, $09, $0b, $2d, $01, $06, $00, $0a, $0a, $00, $00, $03, $09, $09, $48, $0a, $0c, $7f, $14, $0d, $1e, $03, $09, $00, $00, $03, $09, $09, $49, $0b, $0d, $02, $02, $02, $02, $03, $08, $00, $00, $03, $09, $09, $23, $0c, $0e, $4f, $1e, $1e, $00, $0c, $06, $00, $00, $03, $09, $09, $6a, $0e, $10, $7f, $03, $0c, $00, $0d, $02, $00, $ff, $00, $03, $09, $03, $01, $00, $04, $00, $22, $ae, $76, $00, $00, $0a, $04, $01, $03, $01, $01, $02, $04, $00, $22, $67, $77, $00, $00
ELIF DEF(STAR)
	db $07, $04, $01, $01, $03, $0c, $15, $12, $16, $12, $2e, $01, $0b, $02, $01, $03, $0e, $10, $08, $10, $09, $2e, $03, $08, $0b, $03, $18, $00, $03, $09, $09, $46, $09, $0b, $78, $14, $14, $00, $0a, $0a, $00, $00, $03, $09, $09, $48, $0a, $0c, $7f, $14, $0d, $1e, $03, $09, $00, $00, $03, $09, $09, $49, $0b, $0d, $02, $02, $02, $02, $03, $08, $00, $00, $03, $09, $09, $25, $0c, $0e, $79, $18, $18, $00, $0c, $06, $00, $00, $03, $09, $09, $6a, $0e, $10, $7f, $03, $0c, $00, $0d, $02, $00, $ff, $00, $03, $09, $03, $01, $00, $04, $00, $22, $ae, $76, $00, $00, $0a, $04, $01, $03, $01, $01, $02, $04, $00, $22, $67, $77, $00, $00
ENDC
