...
Func_89d8a:
	...
	jp nz, label_89dca ; 89DC4 (22:5dc4) -> C2 CA 5D
	jp label_89df8 ; 89DC7 (22:5dc7) -> C3 F8 5D
label_89dca:
	...
	scall Func_80688 ; 89DDE (22:5dde) -> CD 88 46
...
Func_89eaf:: ; 89eaf
	...
	jp nz, label_89ede ; 89ED3 (22:5ed3) -> C2 DE 5E
...
label_89ede:
	...
	scall FadeInMap ; 89EEB (22:5eeb) -> CD 1C 40
...
Func_89f1e:	push af ; 89F1E (22:5f1e) -> F5
	...
	jp nz, label_89f74 ; 89F21 (22:5f21) -> C2 74 5F
	...
	jp nz, label_89f6e ; 89F31 (22:5f31) -> C2 6E 5F
	...
	jp nz, label_89f65 ; 89F41 (22:5f41) -> C2 65 5F
	...
	jp nz, label_89f54 ; 89F4E (22:5f4e) -> C2 54 5F
	jp label_89f74 ; 89F51 (22:5f51) -> C3 74 5F
label_89f54:
...
Func_89fa8:
	...
	jp nz, label_89ffe ; 89FAB (22:5fab) -> C2 FE 5F
	...
	jp nz, label_89ff8 ; 89FBB (22:5fbb) -> C2 F8 5F
	...
	jp nz, label_89fef ; 89FCB (22:5fcb) -> C2 EF 5F
	...
	jp nz, label_89fde ; 89FD8 (22:5fd8) -> C2 DE 5F
	jp label_89ffe ; 89FDB (22:5fdb) -> C3 FE 5F
label_89fde:
...
Func_8a031:
	...
	jp nz, label_8a087 ; 8A034 (22:6034) -> C2 87 60
	...
	jp nz, label_8a081 ; 8A044 (22:6044) -> C2 81 60
	...
	jp nz, label_8a078 ; 8A054 (22:6054) -> C2 78 60
	...
	jp nz, label_8a067 ; 8A061 (22:6061) -> C2 67 60
	jp label_8a087 ; 8A064 (22:6064) -> C3 87 60
label_8a067:
...
Func_8a0b7:
	...
	jp nz, label_8a10d ; 8A0BA (22:60ba) -> C2 0D 61
	...
	jp nz, label_8a107 ; 8A0CA (22:60ca) -> C2 07 61
	...
	jp nz, label_8a0fe ; 8A0DA (22:60da) -> C2 FE 60
	...
	jp nz, label_8a0ed ; 8A0E7 (22:60e7) -> C2 ED 60
	jp label_8a10d ; 8A0EA (22:60ea) -> C3 0D 61
label_8a0ed:
...
Func_8a115:
	...
	jp nz, label_8a12f ; 8A117 (22:6117) -> C2 2F 61
	ld a, [wc790] ; 8A11A (22:611a) -> FA 90 C7
	or a ; 8A11D (22:611d) -> B7
	jp z, label_8a129 ; 8A11E (22:611e) -> CA 29 61
	ld a, [wc790] ; 8A121 (22:6121) -> FA 90 C7
	cp $07 ; 8A124 (22:6124) -> FE 07
	jp nz, label_8a12f ; 8A126 (22:6126) -> C2 2F 61
label_8a129:
...
Func_8a1f3:: ; 8a1f3
	...
	jp nz, label_8a23d ; 8A220 (22:6220) -> C2 3D 62
	...
	jp label_8a24c ; 8A23A (22:623a) -> C3 4C 62
label_8a23d:
...
label_8a24c:
	...
	scall FadeInMap ; 8A251 (22:6251) -> CD 1C 40
...
Func_8a284:
	...
	jp nz, label_8a2da ; 8A287 (22:6287) -> C2 DA 62
	...
	jp nz, label_8a2d4 ; 8A297 (22:6297) -> C2 D4 62
	...
	jp nz, label_8a2cb ; 8A2A7 (22:62a7) -> C2 CB 62
	...
	jp nz, label_8a2ba ; 8A2B4 (22:62b4) -> C2 BA 62
	jp label_8a2da ; 8A2B7 (22:62b7) -> C3 DA 62
label_8a2ba:
...
Func_8a30a:
	...
	jp nz, label_8a360 ; 8A30D (22:630d) -> C2 60 63
	...
	jp nz, label_8a35a ; 8A31D (22:631d) -> C2 5A 63
	...
	jp nz, label_8a351 ; 8A32D (22:632d) -> C2 51 63
	...
	jp nz, label_8a340 ; 8A33A (22:633a) -> C2 40 63
	jp label_8a360 ; 8A33D (22:633d) -> C3 60 63
label_8a340:
...
Func_8a393:
	...
	jp nz, label_8a3ea ; 8A397 (22:6397) -> C2 EA 63
	...
	jp nz, label_8a3e4 ; 8A3A7 (22:63a7) -> C2 E4 63
	...
	jp nz, label_8a3db ; 8A3B7 (22:63b7) -> C2 DB 63
	...
	jp nz, label_8a3ca ; 8A3C4 (22:63c4) -> C2 CA 63
	jp label_8a3ea ; 8A3C7 (22:63c7) -> C3 EA 63
label_8a3ca:
...
Func_84a1d:
	...
	jp nz, label_8a473 ; 8A420 (22:6420) -> C2 73 64
	...
	jp nz, label_8a46d ; 8A430 (22:6430) -> C2 6D 64
	...
	jp nz, label_8a464 ; 8A440 (22:6440) -> C2 64 64
	...
	jp nz, label_8a453 ; 8A44D (22:644d) -> C2 53 64
	jp label_8a473 ; 8A450 (22:6450) -> C3 73 64
label_8a453:
...
Func_8a480:
	...
	jp label_8a5a3 ; 8A59A (22:659a) -> C3 A3 65
label_8a59d:
...
Func_8a5a5:
	...
	jp nz, label_8a5bf ; 8A5A7 (22:65a7) -> C2 BF 65
	ld a, [wc790] ; 8A5AA (22:65aa) -> FA 90 C7
	or a ; 8A5AD (22:65ad) -> B7
	jp z, label_8a5b9 ; 8A5AE (22:65ae) -> CA B9 65
	ld a, [wc790] ; 8A5B1 (22:65b1) -> FA 90 C7
	cp $07 ; 8A5B4 (22:65b4) -> FE 07
	jp nz, label_8a5bf ; 8A5B6 (22:65b6) -> C2 BF 65
label_8a5b9:
...
Func_8a5e7:
	...
	jp nz, label_8a606 ; 8A5EF (22:65ef) -> C2 06 66
...
Func_8a69b:: ; 8a69b
	...
	jp z, label_8a6de ; 8A6C5 (22:66c5) -> CA DE 66
	ld a, [wc790] ; 8A6C8 (22:66c8) -> FA 90 C7
	cp $07 ; 8A6CB (22:66cb) -> FE 07
	jp nc, label_8a6de ; 8A6CD (22:66cd) -> D2 DE 66
...
label_8a71a:
	scall FadeInMap ; 8A71A (22:671a) -> CD 1C 40
...
Func_8a724:
	...
	jp nz, label_8a74f ; 8A726 (22:6726) -> C2 4F 67
...
Func_8a779:
	...
	jp nz, label_8a7cf ; 8A77C (22:677c) -> C2 CF 67
	...
	jp nz, label_8a7c9 ; 8A78C (22:678c) -> C2 C9 67
	...
	jp nz, label_8a7c0 ; 8A79C (22:679c) -> C2 C0 67
	...
	jp nz, label_8a7af ; 8A7A9 (22:67a9) -> C2 AF 67
	jp label_8a7cf ; 8A7AC (22:67ac) -> C3 CF 67
label_8a7af:
...
Func_8a801:
	...
	jp nz, label_8a857 ; 8A804 (22:6804) -> C2 57 68
	...
	jp nz, label_8a851 ; 8A814 (22:6814) -> C2 51 68
	...
	jp nz, label_8a848 ; 8A824 (22:6824) -> C2 48 68
	...
	jp nz, label_8a837 ; 8A831 (22:6831) -> C2 37 68
	jp label_8a857 ; 8A834 (22:6834) -> C3 57 68
label_8a837:
...
Func_8a892:
	...
	jp nz, label_8a92e ; 8A895 (22:6895) -> C2 2E 69
	...
	jp nz, label_8a915 ; 8A8A5 (22:68a5) -> C2 15 69
	...
	jp nz, label_8a90c ; 8A8B5 (22:68b5) -> C2 0C 69
	...
	jp nz, label_8a8c8 ; 8A8C2 (22:68c2) -> C2 C8 68
	jp label_8a92e ; 8A8C5 (22:68c5) -> C3 2E 69
label_8a8c8:
	...
	jp nz, label_8a8eb ; 8A8D2 (22:68d2) -> C2 EB 68
...
label_8a8eb:
	...
	scall Func_80688 ; 8A8F3 (22:68f3) -> CD 88 46
label_8a8f6:
...
Func_8af07:: ; 8af07
	...
	scall FadeInMap ; 8AF21 (22:6f21) -> CD 1C 40
