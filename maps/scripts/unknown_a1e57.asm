...
.asm_a1e7d
	...
	jp nz, .asm_a1f5d
.asm_a1f1b
	loadwilds $05, Data_a1c6d
	jp .asm_a1f65
.asm_a1f26
	loadwilds $05, Data_a1cb3
	jp .asm_a1f65
.asm_a1f31
	loadwilds $05, Data_a1cf9
	jp .asm_a1f65
.asm_a1f3c
	loadwilds $05, Data_a1d3f
	jp .asm_a1f65
.asm_a1f47
	loadwilds $05, Data_a1d85
	jp .asm_a1f65
.asm_a1f52
	loadwilds $05, Data_a1dcb
	jp .asm_a1f65
.asm_a1f5d
	loadwilds $05, Data_a1e11
.asm_a1f65
	ld a, [wc7de]
	inc a
	cp $24
	jp nc, .asm_a1fa5
	set_frame_script Func_a1fe2
	ld a, $04
	scall Random
	ld l, a
	ld h, $00
