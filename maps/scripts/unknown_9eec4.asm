...
Data_9ee60:
	warpdef $01, $09, $01, $01, MAP_18_11, $02, $08, $03, $08, SFX_2E
	warpdef $06, $04, $01, $01, MAP_18_16, $06, $04, $05, $04, SFX_2E

Data_9ee76:
	warpdef $01, $09, $01, $01, MAP_18_12, $02, $08, $03, $08, SFX_2E
	warpdef $06, $04, $01, $01, MAP_18_16, $06, $04, $05, $04, SFX_2E
...
Func_9eec4:: ; 9eec4
	...
	jp nz, .asm_9eeec
.asm_9eedc:
	loadwarps $02, Data_9ee76
	ld a, $06
	ld [wc792], a
	jp .asm_9eef9
.asm_9eeec:
	loadwarps $02, Data_9ee60
	ld a, $03
	ld [wc792], a
.asm_9eef9:
	ld a, $03
	scall Func_80d01
	loadwilds $04, Data_9ee8c
	playmusic SONG_CAVE
	scall Func_8001c
	ret
