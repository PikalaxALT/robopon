...
Func_b5d98:
	push bc ; B5D98 (2d:5d98) -> C5
	push bc ; B5D99 (2d:5d99) -> C5
	ld hl, sp+$03 ; B5D9A (2d:5d9a) -> F8 03
	ld a, $ff ; B5D9C (2d:5d9c) -> 3E FF
	ld [hl], a ; B5D9E (2d:5d9e) -> 77
	ld hl, sp+$02 ; B5D9F (2d:5d9f) -> F8 02
