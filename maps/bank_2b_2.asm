...
Func_af29a:: ; af29a
	call Func_af309 ; AF29A (2b:729a) -> CD 09 73
	ld hl, Func_af309 ; AF29D (2b:729d) -> 21 09 73
	scall Func_80f11 ; AF2A0 (2b:72a0) -> CD 26 62
	ld e, $03 ; AF2A3 (2b:72a3) -> 1E 03
	ld hl, Data_af225 ; AF2A5 (2b:72a5) -> 21 25 72
	scall LoadWarps ; AF2A8 (2b:72a8) -> CD 4F 53
	ld a, $03 ; AF2AB (2b:72ab) -> 3E 03
	scall Func_80d01 ; AF2AD (2b:72ad) -> CD 16 60
	ld e, $05 ; AF2B0 (2b:72b0) -> 1E 05
	ld hl, Data_af246 ; AF2B2 (2b:72b2) -> 21 46 72
	scall LoadEncounters ; AF2B5 (2b:72b5) -> CD 39 60
	ld hl, $004f ; AF2B8 (2b:72b8) -> 21 4F 00
	scall CheckEventFlag ; AF2BB (2b:72bb) -> CD 43 59
	or a ; AF2BE (2b:72be) -> B7
	jp nz, .asm_af2ca ; AF2BF (2b:72bf) -> C2 CA 72
	ld e, $01 ; AF2C2 (2b:72c2) -> 1E 01
	ld hl, Data_af28c ; AF2C4 (2b:72c4) -> 21 8C 72
	scall LoadMapObjects ; AF2C7 (2b:72c7) -> CD 10 54
.asm_af2ca:
	ld a, $08 ; AF2CA (2b:72ca) -> 3E 08
	scall PlayMusic ; AF2CC (2b:72cc) -> CD FB 61
	scall Func_8001c ; AF2CF (2b:72cf) -> CD 31 53
	ld hl, $031e ; AF2D2 (2b:72d2) -> 21 1E 03
	scall LandmarkSign ; AF2D5 (2b:72d5) -> CD 87 62
	ret  ; AF2D8 (2b:72d8) -> C9
...
Func_af309:
	ld hl, $004e ; AF309 (2b:7309) -> 21 4E 00
	scall CheckEventFlag ; AF30C (2b:730c) -> CD 43 59
	cp $01 ; AF30F (2b:730f) -> FE 01
	jp nz, .asm_af347 ; AF311 (2b:7311) -> C2 47 73
	ld hl, Data_af2d9 ; AF314 (2b:7314) -> 21 D9 72
	scall Func_80d9b ; AF317 (2b:7317) -> CD B0 60
	ld hl, Data_af2df ; AF31A (2b:731a) -> 21 DF 72
	scall Func_80d9b ; AF31D (2b:731d) -> CD B0 60
	ld hl, Data_af2e5 ; AF320 (2b:7320) -> 21 E5 72
	scall Func_80d9b ; AF323 (2b:7323) -> CD B0 60
	ld hl, Data_af2eb ; AF326 (2b:7326) -> 21 EB 72
	scall Func_80d9b ; AF329 (2b:7329) -> CD B0 60
	ld hl, Data_af2f1 ; AF32C (2b:732c) -> 21 F1 72
	scall Func_80d9b ; AF32F (2b:732f) -> CD B0 60
	ld hl, Data_af2f7 ; AF332 (2b:7332) -> 21 F7 72
	scall Func_80d9b ; AF335 (2b:7335) -> CD B0 60
	ld hl, Data_af2fd ; AF338 (2b:7338) -> 21 FD 72
	scall Func_80d9b ; AF33B (2b:733b) -> CD B0 60
	ld hl, Data_af303 ; AF33E (2b:733e) -> 21 03 73
	scall Func_80d9b ; AF341 (2b:7341) -> CD B0 60
	scall Func_80f02 ; AF344 (2b:7344) -> CD 17 62
.asm_af347:
	ret  ; AF347 (2b:7347) -> C9

Data_af348:
	db $04, $0e, $ff, $ff

Func_af34c:
	ld a, e ; AF34C (2b:734c) -> 7B
	or a ; AF34D (2b:734d) -> B7
	jp nz, .asm_af384 ; AF34E (2b:734e) -> C2 84 73
	ld hl, $004e ; AF351 (2b:7351) -> 21 4E 00
	scall CheckEventFlag ; AF354 (2b:7354) -> CD 43 59
	or a ; AF357 (2b:7357) -> B7
	jp nz, .asm_af364 ; AF358 (2b:7358) -> C2 64 73
	ld hl, $0145 ; AF35B (2b:735b) -> 21 45 01
	scall PrintTextWithNPCName ; AF35E (2b:735e) -> CD BE 57
	jp .asm_af384 ; AF361 (2b:7361) -> C3 84 73
.asm_af364:
	ld hl, $0146 ; AF364 (2b:7364) -> 21 46 01
	scall PrintTextWithNPCName ; AF367 (2b:7367) -> CD BE 57
	ld e, $01 ; AF36A (2b:736a) -> 1E 01
	ld hl, $004f ; AF36C (2b:736c) -> 21 4F 00
	scall EventFlagAction ; AF36F (2b:736f) -> CD 30 59
	ld bc, Data_af348 ; AF372 (2b:7372) -> 01 48 73
	ld e, $2b ; AF375 (2b:7375) -> 1E 2B
	xor a ; AF377 (2b:7377) -> AF
	scall MovePersonAndWait ; AF378 (2b:7378) -> CD 9D 59
	scall WaitNPCStep ; AF37B (2b:737b) -> CD 21 55
	ld e, $00 ; AF37E (2b:737e) -> 1E 00
	xor a ; AF380 (2b:7380) -> AF
	scall SetPersonVisibilityState ; AF381 (2b:7381) -> CD 52 54
.asm_af384:
	ret  ; AF384 (2b:7384) -> C9
