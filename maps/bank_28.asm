...
Data_a23ea:
	db $22, $1f, $01, $01, $01, $13, $22
	db $1f, $01, $01, $07, $01, $22, $1f, $01, $01, $22, $0a
...
Func_a268b:: ; a268b
	...
	jp nz, label_a26a1 ; A268F (28:668f) -> C2 A1 66
...
label_a26a1:
	...
	jp nz, label_a26b1 ; A26A6 (28:66a6) -> C2 B1 66
...
label_a26b1:
	...
	jp z, label_a2786 ; A26BB (28:66bb) -> CA 86 67
	cp $1d ; A26BE (28:66be) -> FE 1D
	jp z, label_a2786 ; A26C0 (28:66c0) -> CA 86 67
	cp $1c ; A26C3 (28:66c3) -> FE 1C
	jp z, label_a2786 ; A26C5 (28:66c5) -> CA 86 67
	cp $1b ; A26C8 (28:66c8) -> FE 1B
	jp z, label_a2786 ; A26CA (28:66ca) -> CA 86 67
	cp $1a ; A26CD (28:66cd) -> FE 1A
	jp z, label_a2786 ; A26CF (28:66cf) -> CA 86 67
	cp $19 ; A26D2 (28:66d2) -> FE 19
	jp z, label_a277b ; A26D4 (28:66d4) -> CA 7B 67
	cp $18 ; A26D7 (28:66d7) -> FE 18
	jp z, label_a277b ; A26D9 (28:66d9) -> CA 7B 67
	cp $17 ; A26DC (28:66dc) -> FE 17
	jp z, label_a277b ; A26DE (28:66de) -> CA 7B 67
	cp $16 ; A26E1 (28:66e1) -> FE 16
	jp z, label_a277b ; A26E3 (28:66e3) -> CA 7B 67
	cp $15 ; A26E6 (28:66e6) -> FE 15
	jp z, label_a277b ; A26E8 (28:66e8) -> CA 7B 67
	cp $14 ; A26EB (28:66eb) -> FE 14
	jp z, label_a2770 ; A26ED (28:66ed) -> CA 70 67
	cp $13 ; A26F0 (28:66f0) -> FE 13
	jp z, label_a2770 ; A26F2 (28:66f2) -> CA 70 67
	cp $12 ; A26F5 (28:66f5) -> FE 12
	jp z, label_a2770 ; A26F7 (28:66f7) -> CA 70 67
	cp $11 ; A26FA (28:66fa) -> FE 11
	jp z, label_a2770 ; A26FC (28:66fc) -> CA 70 67
	cp $10 ; A26FF (28:66ff) -> FE 10
	jp z, label_a2770 ; A2701 (28:6701) -> CA 70 67
	cp $0f ; A2704 (28:6704) -> FE 0F
	jp z, label_a2765 ; A2706 (28:6706) -> CA 65 67
	cp $0e ; A2709 (28:6709) -> FE 0E
	jp z, label_a2765 ; A270B (28:670b) -> CA 65 67
	cp $0d ; A270E (28:670e) -> FE 0D
	jp z, label_a2765 ; A2710 (28:6710) -> CA 65 67
	cp $0c ; A2713 (28:6713) -> FE 0C
	jp z, label_a2765 ; A2715 (28:6715) -> CA 65 67
	cp $0b ; A2718 (28:6718) -> FE 0B
	jp z, label_a2765 ; A271A (28:671a) -> CA 65 67
	cp $0a ; A271D (28:671d) -> FE 0A
	jp z, label_a275a ; A271F (28:671f) -> CA 5A 67
	cp $09 ; A2722 (28:6722) -> FE 09
	jp z, label_a275a ; A2724 (28:6724) -> CA 5A 67
	cp $08 ; A2727 (28:6727) -> FE 08
	jp z, label_a275a ; A2729 (28:6729) -> CA 5A 67
	cp $07 ; A272C (28:672c) -> FE 07
	jp z, label_a275a ; A272E (28:672e) -> CA 5A 67
	cp $06 ; A2731 (28:6731) -> FE 06
	jp z, label_a275a ; A2733 (28:6733) -> CA 5A 67
	cp $05 ; A2736 (28:6736) -> FE 05
	jp z, label_a274f ; A2738 (28:6738) -> CA 4F 67
	cp $04 ; A273B (28:673b) -> FE 04
	jp z, label_a274f ; A273D (28:673d) -> CA 4F 67
	cp $03 ; A2740 (28:6740) -> FE 03
	jp z, label_a274f ; A2742 (28:6742) -> CA 4F 67
	cp $02 ; A2745 (28:6745) -> FE 02
	jp z, label_a274f ; A2747 (28:6747) -> CA 4F 67
	cp $01 ; A274A (28:674a) -> FE 01
	jp nz, label_a2791 ; A274C (28:674c) -> C2 91 67
label_a274f:
	ld e, $05 ; A274F (28:674f) -> 1E 05
	ld hl, Data_a24a1 ; A2751 (28:6751) -> 21 A1 64
	scall LoadEncounters ; A2754 (28:6754) -> CD 24 4D
	jp label_a2799 ; A2757 (28:6757) -> C3 99 67
label_a275a:
	ld e, $05 ; A275A (28:675a) -> 1E 05
	ld hl, Data_a24e7 ; A275C (28:675c) -> 21 E7 64
	scall LoadEncounters ; A275F (28:675f) -> CD 24 4D
	jp label_a2799 ; A2762 (28:6762) -> C3 99 67
label_a2765:
	ld e, $05 ; A2765 (28:6765) -> 1E 05
	ld hl, Data_a252d ; A2767 (28:6767) -> 21 2D 65
	scall LoadEncounters ; A276A (28:676a) -> CD 24 4D
	jp label_a2799 ; A276D (28:676d) -> C3 99 67
label_a2770:
	ld e, $05 ; A2770 (28:6770) -> 1E 05
	ld hl, Data_a2573 ; A2772 (28:6772) -> 21 73 65
	scall LoadEncounters ; A2775 (28:6775) -> CD 24 4D
	jp label_a2799 ; A2778 (28:6778) -> C3 99 67
label_a277b:
	ld e, $05 ; A277B (28:677b) -> 1E 05
	ld hl, Data_a25b9 ; A277D (28:677d) -> 21 B9 65
	scall LoadEncounters ; A2780 (28:6780) -> CD 24 4D
	jp label_a2799 ; A2783 (28:6783) -> C3 99 67
label_a2786:
	ld e, $05 ; A2786 (28:6786) -> 1E 05
	ld hl, Data_a25ff ; A2788 (28:6788) -> 21 FF 65
	scall LoadEncounters ; A278B (28:678b) -> CD 24 4D
	jp label_a2799 ; A278E (28:678e) -> C3 99 67
label_a2791:
...
label_a2799:
	...
	jp nc, label_a27d9 ; A279F (28:679f) -> D2 D9 67
...
Data_a2804:
	db $00, $00, $01, $01, $0d, $1b, $00
	db $00, $01, $01, $1e, $1b, $00, $00, $01, $01, $21, $08
...
Data_a282c:
IF DEF(SUN)
	db $21, $0a, $01, $01, $1d, $01, $0a, $04, $0b, $04, $2e, $01, $04, $01, $01
